...
<head>
    ...
    <title>Octopus - Nuevo usuario</title>
                    ...
                    <form method="POST" action="back/user.php">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                ...
                                <input type="text" class="form-control form-control-user" name="surname" placeholder="Apellido">
                            </div>
                            <div class="col-sm-4 mb-3 mb-sm-0">
                        ...
                        <div class="form-group row">
                            ...
                            La contraseña será generada en el primer ingreso del usuario
                            </small>
                        </div>
